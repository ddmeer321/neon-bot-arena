...
const testPanelConfig = readFileSync(new URL("../scripts/config.js", import.meta.url), "utf8");
...
test("production config contains no test-panel access list", () => {
  assert.doesNotMatch(testPanelConfig, /testPanelAccess|testIdKey|\b755051\b|\b809587\b|\b535127\b/);
});
