...
const translations = {
  en: {
    ...
    providersP1: "Depending on the function, GitHub, Netlify, Render, Supabase, and the email provider may receive personal data. Some providers are based in the United States or use subcontractors there.",
    providersP2: "Processing outside the EU or EEA uses the safeguards stated by the provider, such as an adequacy decision, the EU-US Data Privacy Framework, or EU Standard Contractual Clauses.",
    ...
    rightsP1: "Leaderboard entries remain until they are deleted with the matching key. A maximum retention period will be set for the final version. The rate-limit verification value is deleted after one day. Local data remains until you delete it.",
  ...
  fr: {
    ...
    providersP1: "Selon la fonction, GitHub, Netlify, Render, Supabase et le fournisseur de messagerie peuvent recevoir des données personnelles. Certains sont établis aux États-Unis ou y utilisent des sous-traitants.",
    providersP2: "Les traitements hors de l’UE ou de l’EEE reposent sur les garanties indiquées par le fournisseur, comme une décision d’adéquation, le cadre UE–États-Unis de protection des données ou les clauses contractuelles types de l’UE.",
    ...
    rightsP1: "Les entrées restent jusqu’à leur suppression avec la clé correspondante. Une durée maximale sera fixée dans la version définitive. La valeur de contrôle est supprimée après un jour. Les données locales restent jusqu’à ce que tu les supprimes.",
  ...
  es: {
    ...
    providersP1: "Según la función, GitHub, Netlify, Render, Supabase y el proveedor de correo pueden recibir datos personales. Algunos están en Estados Unidos o utilizan subcontratistas allí.",
    providersP2: "El tratamiento fuera de la UE o del EEE utiliza las garantías indicadas por el proveedor, como una decisión de adecuación, el Marco de Privacidad UE–EE. UU. o cláusulas contractuales tipo de la UE.",
    ...
    rightsP1: "Las entradas permanecen hasta que se eliminan con su clave. Se fijará un plazo máximo para la versión final. El valor del límite se borra después de un día. Los datos locales permanecen hasta que los elimines.",
  ...
  it: {
    ...
    providersP1: "A seconda della funzione, GitHub, Netlify, Render, Supabase e il provider e-mail possono ricevere dati personali. Alcuni hanno sede negli Stati Uniti o usano subfornitori lì.",
    providersP2: "I trattamenti fuori dall’UE o SEE utilizzano le garanzie indicate dal fornitore, come una decisione di adeguatezza, l’EU-US Data Privacy Framework o le clausole contrattuali standard dell’UE.",
    rightsTitle: "Conservazione e diritti",
    rightsPreview: "Qui è indicato per quanto tempo restano i dati e quali diritti hai.",
    rightsP1: "Le voci restano fino all’eliminazione con la chiave associata. Nella versione finale verrà definito un periodo massimo. Il valore anti-abuso viene eliminato dopo un giorno. I dati locali restano finché non li elimini.",
  ...
  pl: {
    ...
    providersP1: "Zależnie od funkcji dane mogą otrzymywać GitHub, Netlify, Render, Supabase i dostawca poczty. Niektórzy mają siedzibę w USA lub korzystają tam z podwykonawców.",
    providersP2: "Przetwarzanie poza UE lub EOG opiera się na zabezpieczeniach wskazanych przez dostawcę, np. decyzji stwierdzającej odpowiedni poziom ochrony, EU-US Data Privacy Framework lub standardowych klauzulach umownych UE.",
    rightsTitle: "Okres przechowywania i twoje prawa",
    rightsPreview: "Tutaj wyjaśniono, jak długo pozostają dane i jakie masz prawa.",
    rightsP1: "Wpisy pozostają do usunięcia odpowiednim kluczem. W wersji końcowej zostanie określony maksymalny okres. Wartość limitu jest usuwana po jednym dniu. Dane lokalne pozostają do czasu ich usunięcia.",
  ...
  nl: {
    ...
    providersP1: "Afhankelijk van de functie kunnen GitHub, Netlify, Render, Supabase en de e-mailprovider persoonsgegevens ontvangen. Sommige zijn in de VS gevestigd of gebruiken daar onderaannemers.",
    providersP2: "Verwerking buiten de EU of EER gebruikt de door de provider genoemde waarborgen, zoals een adequaatheidsbesluit, het EU-US Data Privacy Framework of EU-modelcontractbepalingen.",
    ...
    rightsP1: "Inzendingen blijven totdat ze met de bijbehorende code worden verwijderd. Voor de definitieve versie wordt een maximale termijn vastgesteld. De controlewaarde wordt na één dag verwijderd. Lokale gegevens blijven totdat je ze wist.",
  ...
  "zh-CN": {
    ...
    providersP1: "根据所用功能，GitHub、Netlify、Render、Supabase 和邮箱服务商可能接收个人数据。部分服务商位于美国或在美国使用分包商。",
    providersP2: "欧盟或欧洲经济区以外的处理采用服务商说明的保障机制，例如充分性决定、欧盟—美国数据隐私框架或欧盟标准合同条款。",
    rightsTitle: "保存期限与你的权利",
    rightsPreview: "这里说明数据保存多久以及你享有哪些隐私权利。",
    rightsP1: "排行榜记录会保留到使用对应密钥删除为止。最终版本将设定最长保存期限。限流校验值会在一天后删除。本地数据会保留到你主动删除为止。",
