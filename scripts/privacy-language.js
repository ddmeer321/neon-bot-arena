...
const translations = {
  en: {
    ...
    rightsP1: "Leaderboard entries are automatically deleted no later than 12 months after storage. You can delete them earlier with the matching deletion key. The rate-limit verification value is deleted after one day. Local data remains until you delete it.",
  ...
  fr: {
    ...
    rightsP1: "Les entrées du classement sont automatiquement supprimées au plus tard 12 mois après leur enregistrement. Tu peux les supprimer plus tôt avec la clé correspondante. La valeur de contrôle est supprimée après un jour. Les données locales restent jusqu’à ce que tu les supprimes.",
  ...
  es: {
    ...
    rightsP1: "Las entradas de la clasificación se eliminan automáticamente como máximo 12 meses después de guardarse. Puedes eliminarlas antes con la clave correspondiente. El valor del límite se borra después de un día. Los datos locales permanecen hasta que los elimines.",
  ...
  it: {
    ...
    rightsP1: "Le voci della classifica vengono eliminate automaticamente al più tardi 12 mesi dopo il salvataggio. Puoi eliminarle prima con la chiave associata. Il valore anti-abuso viene eliminato dopo un giorno. I dati locali restano finché non li elimini.",
  ...
  pl: {
    ...
    rightsP1: "Wpisy rankingu są automatycznie usuwane najpóźniej 12 miesięcy po zapisaniu. Można je usunąć wcześniej odpowiednim kluczem. Wartość limitu jest usuwana po jednym dniu. Dane lokalne pozostają do czasu ich usunięcia.",
  ...
  nl: {
    ...
    rightsP1: "Klassementsvermeldingen worden uiterlijk 12 maanden na opslag automatisch verwijderd. Je kunt ze eerder verwijderen met de bijbehorende code. De controlewaarde wordt na één dag verwijderd. Lokale gegevens blijven totdat je ze wist.",
  ...
  "zh-CN": {
    ...
    rightsP1: "排行榜记录最迟会在保存12个月后自动删除。你也可以使用对应的删除密钥提前删除。限流校验值会在一天后删除。本地数据会保留到你主动删除为止。",
