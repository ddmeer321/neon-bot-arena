...
const translations = {
  en: {
    ...
    accountP2: `Registration, login, and password management run through <a href="https://supabase.com/privacy">Supabase</a>, which acts as a processor for this purpose. The legal basis is Article 6(1)(b) GDPR, since creating an account is a function you have expressly requested. On each login attempt, the entered username or email and your IP address are briefly logged and automatically deleted after at most 48 hours; the legal basis for this is Article 6(1)(f) GDPR, to protect against abuse.`,
  ...
  fr: {
    ...
    accountP2: `L’inscription, la connexion et la gestion du mot de passe passent par <a href="https://supabase.com/privacy">Supabase</a>, qui agit à ce titre comme sous-traitant. La base juridique est l’article 6, paragraphe 1, point b du RGPD, la création d’un compte étant une fonction que tu as expressément demandée. À chaque tentative de connexion, le nom d’utilisateur ou l’e-mail saisi ainsi que ton adresse IP sont brièvement enregistrés puis automatiquement supprimés au plus tard après 48 heures ; la base juridique est alors l’article 6, paragraphe 1, point f du RGPD, à des fins de protection contre les abus.`,
  ...
  it: {
    ...
    accountP2: `Registrazione, login e gestione della password avvengono tramite <a href="https://supabase.com/privacy">Supabase</a>, che agisce in tal senso come responsabile del trattamento. La base giuridica è l’art. 6, par. 1, lett. b GDPR, poiché la creazione dell’account è una funzione richiesta espressamente da te. Ad ogni tentativo di accesso vengono registrati brevemente il nome utente o l’e-mail inseriti e il tuo indirizzo IP, eliminati automaticamente al massimo dopo 48 ore; la base giuridica per questo è l’art. 6, par. 1, lett. f GDPR, a tutela contro gli abusi.`,
  ...
  nl: {
    ...
    accountP2: `Registratie, login en wachtwoordbeheer verlopen via <a href="https://supabase.com/privacy">Supabase</a>, dat daarbij optreedt als verwerker. De grondslag is artikel 6 lid 1 onder b AVG, omdat het aanmaken van een account een door jou uitdrukkelijk gewenste functie is. Bij elke inlogpoging worden de ingevoerde gebruikersnaam of e-mail en je IP-adres kort geregistreerd en uiterlijk na 48 uur automatisch verwijderd; de grondslag hiervoor is artikel 6 lid 1 onder f AVG, ter bescherming tegen misbruik.`,
  ...
  "zh-CN": {
    ...
    accountP2: `注册、登录和密码管理通过 <a href="https://supabase.com/privacy">Supabase</a> 进行，Supabase 在此过程中作为受托处理方。法律依据为《通用数据保护条例》第6条第1款b项，因为创建账户是你明确要求使用的功能。每次登录尝试时，系统会短暂记录你输入的用户名或邮箱以及你的 IP 地址，并最迟在48小时后自动删除；此项处理的法律依据为《通用数据保护条例》第6条第1款f项，用于防止滥用。`,
