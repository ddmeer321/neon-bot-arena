...
const translations = {
  de: {
    ...
    "mode.oneHeart": "One Heart",
    "mode.oneHeartDescription": "Ein einziger Treffer beendet deinen Run.",
    "chaos.eventLabel": "Chaos-Event",
    "chaos.event.turbo": "Turbo – 55 % schneller",
    "chaos.event.rapidFire": "Schnellfeuer – doppelte Feuerrate",
    "chaos.event.overdrive": "Overdrive – 80 % mehr Schaden",
    "chaos.event.robotRage": "Roboter-Raserei – Gegner stärker",
    "chaos.event.healingRain": "Heilregen – Leben regeneriert",
    "chaos.event.glassCannon": "Glaskanone – alle verursachen mehr Schaden",
    "hud.hero": "Figur",
    "hud.wave": "Welle",
    "hud.score": "Punkte",
  ...
  en: {
    ...
    "mode.oneHeart": "One Heart",
    "mode.oneHeartDescription": "A single hit ends your run.",
    "chaos.eventLabel": "Chaos event",
    "chaos.event.turbo": "Turbo – 55% faster",
    "chaos.event.rapidFire": "Rapid fire – double fire rate",
    "chaos.event.overdrive": "Overdrive – 80% more damage",
    "chaos.event.robotRage": "Robot rage – stronger enemies",
    "chaos.event.healingRain": "Healing rain – health regenerates",
    "chaos.event.glassCannon": "Glass cannon – everyone deals more damage",
    "hud.hero": "Hero",
    "hud.wave": "Wave",
    "hud.score": "Score",
  ...
  fr: {
    ...
    "mode.oneHeart": "One Heart",
    "mode.oneHeartDescription": "Un seul coup met fin à ta partie.",
    "chaos.eventLabel": "Événement chaos",
    "chaos.event.turbo": "Turbo – 55 % plus rapide",
    "chaos.event.rapidFire": "Tir rapide – cadence doublée",
    "chaos.event.overdrive": "Surcharge – 80 % de dégâts en plus",
    "chaos.event.robotRage": "Rage des robots – ennemis renforcés",
    "chaos.event.healingRain": "Pluie curative – vie régénérée",
    "chaos.event.glassCannon": "Canon de verre – dégâts augmentés pour tous",
    "hud.hero": "Héros",
    "hud.wave": "Vague",
    "hud.score": "Score",
  ...
  es: {
    ...
    "mode.oneHeart": "One Heart",
    "mode.oneHeartDescription": "Un solo golpe termina tu partida.",
    "chaos.eventLabel": "Evento de caos",
    "chaos.event.turbo": "Turbo – 55 % más rápido",
    "chaos.event.rapidFire": "Fuego rápido – cadencia doble",
    "chaos.event.overdrive": "Sobrecarga – 80 % más de daño",
    "chaos.event.robotRage": "Furia robótica – enemigos más fuertes",
    "chaos.event.healingRain": "Lluvia curativa – regeneras vida",
    "chaos.event.glassCannon": "Cañón de cristal – todos hacen más daño",
    "hud.hero": "Héroe",
    "hud.wave": "Oleada",
    "hud.score": "Puntos",
  ...
  it: {
    ...
    "mode.oneHeart": "One Heart",
    "mode.oneHeartDescription": "Un solo colpo termina la partita.",
    "chaos.eventLabel": "Evento caos",
    "chaos.event.turbo": "Turbo – 55% più veloce",
    "chaos.event.rapidFire": "Fuoco rapido – cadenza doppia",
    "chaos.event.overdrive": "Overdrive – 80% di danni in più",
    "chaos.event.robotRage": "Furia robot – nemici potenziati",
    "chaos.event.healingRain": "Pioggia curativa – vita rigenerata",
    "chaos.event.glassCannon": "Cannone di vetro – tutti infliggono più danni",
    "hud.hero": "Eroe",
    "hud.wave": "Ondata",
    "hud.score": "Punti",
  ...
  pl: {
    ...
    "mode.oneHeart": "One Heart",
    "mode.oneHeartDescription": "Jedno trafienie kończy rozgrywkę.",
    "chaos.eventLabel": "Wydarzenie chaosu",
    "chaos.event.turbo": "Turbo – 55% szybciej",
    "chaos.event.rapidFire": "Szybki ogień – podwójna szybkostrzelność",
    "chaos.event.overdrive": "Przeciążenie – 80% więcej obrażeń",
    "chaos.event.robotRage": "Szał robotów – silniejsi wrogowie",
    "chaos.event.healingRain": "Leczący deszcz – regeneracja życia",
    "chaos.event.glassCannon": "Szklane działo – wszyscy zadają więcej obrażeń",
    "hud.hero": "Postać",
    "hud.wave": "Fala",
    "hud.score": "Punkty",
  ...
  nl: {
    ...
    "mode.oneHeart": "One Heart",
    "mode.oneHeartDescription": "Eén treffer beëindigt je run.",
    "chaos.eventLabel": "Chaos-event",
    "chaos.event.turbo": "Turbo – 55% sneller",
    "chaos.event.rapidFire": "Snelvuur – dubbele vuursnelheid",
    "chaos.event.overdrive": "Overdrive – 80% meer schade",
    "chaos.event.robotRage": "Robotwoede – sterkere vijanden",
    "chaos.event.healingRain": "Helende regen – leven herstelt",
    "chaos.event.glassCannon": "Glazen kanon – iedereen doet meer schade",
    "hud.hero": "Held",
    "hud.wave": "Golf",
    "hud.score": "Score",
  ...
  "zh-CN": {
    ...
    "mode.oneHeart": "一击模式",
    "mode.oneHeartDescription": "受到一次攻击就会结束本局。",
    "chaos.eventLabel": "混乱事件",
    "chaos.event.turbo": "涡轮加速 – 速度提高 55%",
    "chaos.event.rapidFire": "快速射击 – 射速翻倍",
    "chaos.event.overdrive": "超载 – 伤害提高 80%",
    "chaos.event.robotRage": "机器人狂暴 – 敌人更强",
    "chaos.event.healingRain": "治疗之雨 – 持续恢复生命",
    "chaos.event.glassCannon": "玻璃大炮 – 所有人伤害提高",
    "hud.hero": "英雄",
    "hud.wave": "波次",
    "hud.score": "分数",
    "hud.difficulty": "难度",
