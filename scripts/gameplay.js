...
import { saveHighScore, saveLeaderboardEntry } from "./storage.js?v=upgrade10";
import { addCoins, calculateCoinReward, getSelectedHeroStats } from "./economy.js?v=upgrade10";
import { loadOnlineScores, submitOnlineScore } from "./online-leaderboard.js?v=upgrade10";
import { playShoot, setMusicPaused, startMusic, stopMusic } from "./audio.js?v=upgrade10";
